import { IOptions, ICallBackOptions, ICameraOptions, IScanOptions, ITrackingOptions, EventConflation, Facing} from "../plugin";
import { IFastBarcodeScannerPlugin } from "../plugin";
